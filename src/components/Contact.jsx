...
let { VITE_APP_SERVICE, VITE_APP_TEMPLATE, VITE_APP_PASSWORD } = import.meta
  .env;
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (name === "" || email === "" || message === "") {
      alert(
        "You cannot send an empty form! If you used autofill, please try again."
      );
    } else {
      let params = {
        from_name: name,
    ...
    <div className={`page contact ${isActive ? "active" : ""}`}>
      ...
      <div className="card" style={{ gap: isMobile ? "2rem" : null }}>
        <p
          ...
          style={{ fontSize: isMobile ? "1.25rem" : null }}
        >
        ...
        <div className="contact-modal">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p>
                Thanks for reaching out! <br />I will be in touch soon.
              </p>
              <button
                className="close-btn"
                onClick={() => {
