    ...
    <div className={`page ${isActive ? "active" : ""}`}>
      ...
      <div id="landing">
        ...
        <h2
          ...
          style={{ fontSize: isMobile ? "7rem" : null }}
          onClick={handleClick}
        >
          Noise
        </h2>
      ...
      <div
        ...
        style={{
          display: "none",
          opacity: 0,
          fontSize: isMobile ? "1.25rem" : null,
        }}
      >
        <p className="info-text">
          I am a middle-stack web developer leveraging a background in{" "}
          <a
          ...
          production to exercise critical thinking, creativity and anticipation
          of user needs. My knowledge of HTML, CSS, Javascript, and ensures both
          a smooth user experience and clean, concise code. Working on projects
          asynchronously with diverse teams has strengthened my skills in
          communication, collaboration and Git. Using these strengths, I strive
          to build accessible, intuitive, and responsive web apps for a
        ...
        <a
          ...
          href="https://drive.google.com/file/d/1uxrLRjRBJ4kJ5gCcIJGjHane8erqp9FW/view?usp=drive_link"
